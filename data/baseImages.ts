const regionImages = {
  ...
  southeast:  "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&w=600&q=80",
  ...
  south:      "https://images.unsplash.com/photo-1513584684374-8bab748fbf90?auto=format&fit=crop&w=600&q=80",
} as const;
...
const stateRegion: Record<string, Region> = {
  ...
  HI: "southeast", MS: "southeast", NC: "southeast", SC: "southeast",
  // Southwest / desert
