              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                  ...
                  <div>
                    ...
                    <input name="phone" value={form.phone} onChange={handleChange} type="tel" placeholder="(555) 123-4567" style={inputStyle} />
                  </div>
                </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div style={{ backgroundColor: "#111827", border: "1px solid #1f2937", borderRadius: "12px", padding: "1.75rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                <a href="tel:+15551234567" style={{ display: "flex", alignItems: "center", gap: "0.75rem", color: "#d1d5db", textDecoration: "none", fontSize: "0.875rem" }}>
                ...
                <a href="mailto:zack@example.com" style={{ display: "flex", alignItems: "center", gap: "0.75rem", color: "#d1d5db", textDecoration: "none", fontSize: "0.875rem" }}>
                  <div style={{ width: "36px", height: "36px", backgroundColor: "rgba(245, 197, 24, 0.1)", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
